...
########################################################
##                                                    ##
##          CURSO INICIACIÓN AL LENGUAJE R            ##
##                                                    ##
##                     Script  1                      ##
##                                                    ##
########################################################
...
# Primera cosa que vemos la # que me sirve para introducir notas

# Vamos con algo muy simple: escribimos 1+1 y ejecutamos RUN

1+1

# Vamos con algunas funciones básicas de R
...
# Vemos como en la consola tenemos un línea con la operación 1+2
# y luego el resultado 2 con un número precedido de 2 corchetes
# [1] 2. El número entre corchete [1] no es el resultado, sino el 
# número índice del primer elemento de cada línea nueva. Ese número 
# puede incrementarse como verás.
